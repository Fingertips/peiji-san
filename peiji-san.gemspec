...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/peiji_san", "lib/peiji_san/view_helper.rb", "lib/peiji_san.rb", "test/peiji_san_test.rb", "test/test_helper.rb", "test/view_helper_test.rb", "LICENSE"]
  s.has_rdoc = true
